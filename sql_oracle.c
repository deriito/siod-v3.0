...
char *cda_errmsg(struct cda_def *cur) { return (errmsg(cur->rc)); }

char *lda_errmsg() { return (errmsg(lda.rc)); }
...
LISP oracle_nselects(LISP s) { return (flocons((get_cstatement(s))->nselects)); }
